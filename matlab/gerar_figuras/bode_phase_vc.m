...
[MAG_1, PHASE_1] = bode(G_u_vC_i2, t);
[MAG_2, PHASE_2] = bode(Go_vC, t);
[MAG_3, PHASE_3] = bode(dnm_vC, t);
...
set(gca, 'YTick', [-450 -360 -270 -180 -90 0 90 180 270 360 450]);
...
if exportar==1
    ...
    %Exporta
    matlab2tikz('./bode_phase_vc.tex', 'width', '0.8\textwidth', ...
        'encoding', 'UTF-8');
end