...
cor1=define_cor(colorido, 4);
cor2=define_cor(colorido, 4);
cor3=define_cor(colorido, 4);
...
xticks = [19/60 20/60 21/60 22/60];
...
if exportar==1
    ...
    %Exporta
    matlab2tikz('./theta_sim_phase_vc.tex', 'width', '0.8\textwidth', ...
