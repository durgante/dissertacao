...
static const char * c2_debug_family_names[43] = { "kp_kd", "Kp", "p1", "p2",
  "km", "gamaD", "gama", "delta0", "rede", "u_k", "eta_k", "i2m_k", "e1_k",
  "v_k", "q_k", "e2_k", "ea_k", "m2_k", "nargin", "nargout", "i2ref_k", "i2_k",
  "vc_k", "t", "up", "theta", "theta_k", "omega_k", "omega_k_1", "omega_k_2",
...
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_c_emlrt_marshallIn(SFc2_vC_1ph_MR2InstanceStruct *chartInstance,
  const mxArray *c2_b_u_k_1, const char_T *c2_identifier);
static real_T c2_d_emlrt_marshallIn(SFc2_vC_1ph_MR2InstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
...
static const mxArray *c2_l_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_w_emlrt_marshallIn(SFc2_vC_1ph_MR2InstanceStruct *chartInstance,
  const mxArray *c2_b_eta_k_2, const char_T *c2_identifier, real_T c2_y[6]);
static void c2_x_emlrt_marshallIn(SFc2_vC_1ph_MR2InstanceStruct *chartInstance,
...
static const mxArray *c2_m_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_y_emlrt_marshallIn(SFc2_vC_1ph_MR2InstanceStruct *chartInstance,
  const mxArray *c2_b_eta_k_1, const char_T *c2_identifier, real_T c2_y[6]);
static void c2_ab_emlrt_marshallIn(SFc2_vC_1ph_MR2InstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId, real_T c2_y[6]);
...
static const mxArray *c2_n_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_bb_emlrt_marshallIn(SFc2_vC_1ph_MR2InstanceStruct *chartInstance,
  const mxArray *c2_b_omega_k_2, const char_T *c2_identifier, real_T c2_y[6]);
static void c2_cb_emlrt_marshallIn(SFc2_vC_1ph_MR2InstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId, real_T c2_y[6]);
...
static const mxArray *c2_o_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_db_emlrt_marshallIn(SFc2_vC_1ph_MR2InstanceStruct *chartInstance,
  const mxArray *c2_b_omega_k_1, const char_T *c2_identifier, real_T c2_y[6]);
static void c2_eb_emlrt_marshallIn(SFc2_vC_1ph_MR2InstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId, real_T c2_y[6]);
...
static const mxArray *c2_p_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_fb_emlrt_marshallIn(SFc2_vC_1ph_MR2InstanceStruct *chartInstance,
  const mxArray *c2_b_omega_k, const char_T *c2_identifier, real_T c2_y[6]);
static void c2_gb_emlrt_marshallIn(SFc2_vC_1ph_MR2InstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId, real_T c2_y[6]);
...
static const mxArray *c2_s_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_lb_emlrt_marshallIn(SFc2_vC_1ph_MR2InstanceStruct
  *chartInstance, const mxArray *c2_up, const char_T *c2_identifier);
static real_T c2_mb_emlrt_marshallIn(SFc2_vC_1ph_MR2InstanceStruct
...
static const mxArray *c2_t_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_nb_emlrt_marshallIn(SFc2_vC_1ph_MR2InstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_t_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_ob_emlrt_marshallIn(SFc2_vC_1ph_MR2InstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_vC_1ph_MR2, const char_T
  *c2_identifier);
static uint8_T c2_pb_emlrt_marshallIn(SFc2_vC_1ph_MR2InstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
  ...
  chartInstance)
{
  ...
  c2_m_hoistedGlobal = chartInstance->c2_is_active_c2_vC_1ph_MR2;
  ...
  *chartInstance, const mxArray *c2_st)
{
  ...
  *c2_up = c2_lb_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c2_u,
    1)), "up");
  ...
  chartInstance->c2_is_active_c2_vC_1ph_MR2 = c2_ob_emlrt_marshallIn
...
static void sf_c2_vC_1ph_MR2(SFc2_vC_1ph_MR2InstanceStruct *chartInstance)
{
  ...
  for (c2_i14 = 0; c2_i14 < 6; c2_i14++) {
    _SFD_DATA_RANGE_CHECK((*c2_theta)[c2_i14], 4U);
  }
  ...
  *chartInstance)
{
  ...
  real_T c2_theta[6];
  int32_T c2_i15;
  static real_T c2_dv7[6] = { 0.3258, -2.9077, -0.2815, 13.1402, 0.0, 0.0 };
  ...
  sf_debug_symbol_scope_push_eml(0U, 43U, 43U, c2_debug_family_names,
  ...
  sf_debug_symbol_scope_add_eml(&c2_rede, 8U, c2_s_sf_marshallOut);
  sf_debug_symbol_scope_add_eml_importable(&c2_u_k, 9U, c2_s_sf_marshallOut,
    c2_s_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(c2_eta_k, 10U, c2_r_sf_marshallOut,
    c2_r_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_i2m_k, 11U, c2_s_sf_marshallOut,
    c2_s_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_e1_k, 12U, c2_s_sf_marshallOut,
    c2_s_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_v_k, 13U, c2_s_sf_marshallOut,
    c2_s_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_q_k, 14U, c2_s_sf_marshallOut,
    c2_s_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_e2_k, 15U, c2_s_sf_marshallOut,
    c2_s_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_ea_k, 16U, c2_s_sf_marshallOut,
    c2_s_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_m2_k, 17U, c2_s_sf_marshallOut,
    c2_s_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_nargin, 18U, c2_s_sf_marshallOut,
    c2_s_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_nargout, 19U, c2_s_sf_marshallOut,
    c2_s_sf_marshallIn);
  sf_debug_symbol_scope_add_eml(&c2_i2ref_k, 20U, c2_s_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c2_i2_k, 21U, c2_s_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c2_vc_k, 22U, c2_s_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c2_t, 23U, c2_s_sf_marshallOut);
  sf_debug_symbol_scope_add_eml_importable(&c2_up, 24U, c2_s_sf_marshallOut,
    c2_s_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(c2_theta, 25U, c2_r_sf_marshallOut,
    c2_r_sf_marshallIn);
  ...
  sf_debug_symbol_scope_add_eml_importable(&chartInstance->c2_vc_k_1, 40U,
    c2_c_sf_marshallOut, c2_c_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&chartInstance->c2_u_k_1, 41U,
    c2_b_sf_marshallOut, c2_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&chartInstance->c2_u_k_2, 42U,
  ...
  c2_f_b = c2_g_hoistedGlobal - c2_h_hoistedGlobal;
  c2_f_y = 3.0 * c2_f_b;
  c2_up = c2_e_y - c2_f_y;
  ...
  c2_m2_k = (c2_n_y + c2_mpower(chartInstance, c2_e2_k)) + chartInstance->c2_m2;
  ...
  for (c2_i41 = 0; c2_i41 < 6; c2_i41++) {
    c2_theta[c2_i41] = chartInstance->c2_theta_k[c2_i41];
  }
  ...
  c2_h_x = c2_g_x;
  c2_v_y = c2_u_y;
  c2_w_y = c2_h_x / c2_v_y;
  chartInstance->c2_rho_k = c2_q_hoistedGlobal - c2_w_y;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 163U);
  c2_r_hoistedGlobal = chartInstance->c2_m2;
  c2_q_b = c2_r_hoistedGlobal - 1.0;
  c2_x_y = 0.99 * c2_q_b;
  chartInstance->c2_m2 = ((c2_x_y + c2_abs(chartInstance, c2_u_k)) + c2_abs
  ...
  c2_s_b = c2_u_k;
  c2_ab_y = c2_s_b;
  chartInstance->c2_omega_k[0] = c2_y_y + c2_ab_y;
  ...
  c2_u_b = c2_i2_k;
  c2_cb_y = c2_u_b;
  chartInstance->c2_omega_k[1] = c2_bb_y + c2_cb_y;
  ...
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, -186);
  sf_debug_symbol_scope_pop();
  *c2_b_up = c2_up;
  for (c2_i48 = 0; c2_i48 < 6; c2_i48++) {
    (*c2_b_theta)[c2_i48] = c2_theta[c2_i48];
  }
  ...
  *chartInstance, const mxArray *c2_up, const char_T *c2_identifier)
{
  ...
  c2_thisId.fIdentifier = c2_identifier;
  c2_thisId.fParent = NULL;
  c2_y = c2_mb_emlrt_marshallIn(chartInstance, sf_mex_dup(c2_up), &c2_thisId);
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(807659678U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2500981668U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(4034817050U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3649178049U);
}
...
mxArray *sf_c2_vC_1ph_MR2_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("kfLhZ9AXWGAolCrbvOIwiD");
...
static const mxArray *sf_get_sim_state_info_c2_vC_1ph_MR2(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x10'type','srcId','name','auxInfo'{{M[1],M[16],T\"theta\",},{M[1],M[5],T\"up\",},{M[4],M[0],T\"eta_k_1\",S'l','i','p'{{M1x2[901 908],M[0],}}},{M[4],M[0],T\"eta_k_2\",S'l','i','p'{{M1x2[978 985],M[0],}}},{M[4],M[0],T\"i2m_k_1\",S'l','i','p'{{M1x2[1055 1062],M[0],}}},{M[4],M[0],T\"i2m_k_2\",S'l','i','p'{{M1x2[1115 1122],M[0],}}},{M[4],M[0],T\"i2ref_k_1\",S'l','i','p'{{M1x2[1175 1184],M[0],}}},{M[4],M[0],T\"i2ref_k_2\",S'l','i','p'{{M1x2[1241 1250],M[0],}}},{M[4],M[0],T\"m2\",S'l','i','p'{{M1x2[1473 1475],M[0],}}},{M[4],M[0],T\"omega_k\",S'l','i','p'{{M1x2[658 665],M[0],}}}}",
    "100 S1x10'type','srcId','name','auxInfo'{{M[4],M[0],T\"omega_k_1\",S'l','i','p'{{M1x2[735 744],M[0],}}},{M[4],M[0],T\"omega_k_2\",S'l','i','p'{{M1x2[818 827],M[0],}}},{M[4],M[0],T\"rho_k\",S'l','i','p'{{M1x2[1415 1420],M[0],}}},{M[4],M[0],T\"theta_k\",S'l','i','p'{{M1x2[502 509],M[0],}}},{M[4],M[0],T\"u_k_1\",S'l','i','p'{{M1x2[1575 1580],M[0],}}},{M[4],M[0],T\"u_k_2\",S'l','i','p'{{M1x2[1629 1634],M[0],}}},{M[4],M[0],T\"v_k_1\",S'l','i','p'{{M1x2[1307 1312],M[0],}}},{M[4],M[0],T\"v_k_2\",S'l','i','p'{{M1x2[1361 1366],M[0],}}},{M[4],M[0],T\"vc_k_1\",S'l','i','p'{{M1x2[1518 1524],M[0],}}},{M[8],M[0],T\"is_active_c2_vC_1ph_MR2\",}}"
  };
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML(0,1,1,18,0,0,0,0,0,0);
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,2831);
        _SFD_CV_INIT_EML_IF(0,1,0,511,530,-1,645);
        _SFD_CV_INIT_EML_IF(0,1,1,667,686,-1,722);
        _SFD_CV_INIT_EML_IF(0,1,2,746,767,-1,805);
        _SFD_CV_INIT_EML_IF(0,1,3,829,850,-1,888);
        _SFD_CV_INIT_EML_IF(0,1,4,910,929,-1,965);
        _SFD_CV_INIT_EML_IF(0,1,5,987,1006,-1,1042);
        _SFD_CV_INIT_EML_IF(0,1,6,1064,1083,-1,1102);
        _SFD_CV_INIT_EML_IF(0,1,7,1124,1143,-1,1162);
        _SFD_CV_INIT_EML_IF(0,1,8,1186,1207,-1,1228);
        _SFD_CV_INIT_EML_IF(0,1,9,1252,1273,-1,1294);
        _SFD_CV_INIT_EML_IF(0,1,10,1314,1331,-1,1348);
        _SFD_CV_INIT_EML_IF(0,1,11,1368,1385,-1,1402);
        _SFD_CV_INIT_EML_IF(0,1,12,1422,1439,-1,1460);
        _SFD_CV_INIT_EML_IF(0,1,13,1477,1491,-1,1505);
        _SFD_CV_INIT_EML_IF(0,1,14,1526,1544,-1,1562);
        _SFD_CV_INIT_EML_IF(0,1,15,1582,1599,-1,1616);
        _SFD_CV_INIT_EML_IF(0,1,16,1636,1653,-1,1670);
        _SFD_CV_INIT_EML_IF(0,1,17,1752,1759,1832,1886);
...

        {
          ...
          _SFD_SET_DATA_VALUE_PTR(4U, *c2_theta);
...
static void mdlSetWorkWidths_c2_vC_1ph_MR2(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(2153188681U));
  ssSetChecksum1(S,(1603498541U));
  ssSetChecksum2(S,(443724735U));
  ssSetChecksum3(S,(3825018546U));
