...
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_c_emlrt_marshallIn(SFc2_vC_3ph_MR2InstanceStruct *chartInstance,
  const mxArray *c2_b_P, const char_T *c2_identifier, real_T c2_y[36]);
static void c2_d_emlrt_marshallIn(SFc2_vC_3ph_MR2InstanceStruct *chartInstance,
...
static const mxArray *c2_l_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_w_emlrt_marshallIn(SFc2_vC_3ph_MR2InstanceStruct *chartInstance,
  const mxArray *c2_b_i2ref_k_2, const char_T *c2_identifier);
static real_T c2_x_emlrt_marshallIn(SFc2_vC_3ph_MR2InstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
...
static const mxArray *c2_m_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_y_emlrt_marshallIn(SFc2_vC_3ph_MR2InstanceStruct *chartInstance,
  const mxArray *c2_b_i2ref_k_1, const char_T *c2_identifier);
static real_T c2_ab_emlrt_marshallIn(SFc2_vC_3ph_MR2InstanceStruct
...
static const mxArray *c2_n_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_bb_emlrt_marshallIn(SFc2_vC_3ph_MR2InstanceStruct
  *chartInstance, const mxArray *c2_b_i2m_k_3, const char_T *c2_identifier);
static real_T c2_cb_emlrt_marshallIn(SFc2_vC_3ph_MR2InstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
...
static const mxArray *c2_o_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_db_emlrt_marshallIn(SFc2_vC_3ph_MR2InstanceStruct
  *chartInstance, const mxArray *c2_b_i2m_k_2, const char_T *c2_identifier);
static real_T c2_eb_emlrt_marshallIn(SFc2_vC_3ph_MR2InstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
...
static const mxArray *c2_p_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_fb_emlrt_marshallIn(SFc2_vC_3ph_MR2InstanceStruct
  *chartInstance, const mxArray *c2_b_i2m_k_1, const char_T *c2_identifier);
static real_T c2_gb_emlrt_marshallIn(SFc2_vC_3ph_MR2InstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
...
static const mxArray *c2_s_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_lb_emlrt_marshallIn(SFc2_vC_3ph_MR2InstanceStruct *chartInstance,
  const mxArray *c2_b_eta_k_1, const char_T *c2_identifier, real_T c2_y[6]);
static void c2_mb_emlrt_marshallIn(SFc2_vC_3ph_MR2InstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId, real_T c2_y[6]);
...
static const mxArray *c2_t_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_nb_emlrt_marshallIn(SFc2_vC_3ph_MR2InstanceStruct *chartInstance,
  const mxArray *c2_b_omega_k_3, const char_T *c2_identifier, real_T c2_y[6]);
static void c2_ob_emlrt_marshallIn(SFc2_vC_3ph_MR2InstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId, real_T c2_y[6]);
...
static const mxArray *c2_u_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_pb_emlrt_marshallIn(SFc2_vC_3ph_MR2InstanceStruct *chartInstance,
  const mxArray *c2_b_omega_k_2, const char_T *c2_identifier, real_T c2_y[6]);
static void c2_qb_emlrt_marshallIn(SFc2_vC_3ph_MR2InstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId, real_T c2_y[6]);
...
static const mxArray *c2_v_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_rb_emlrt_marshallIn(SFc2_vC_3ph_MR2InstanceStruct *chartInstance,
  const mxArray *c2_b_omega_k_1, const char_T *c2_identifier, real_T c2_y[6]);
static void c2_sb_emlrt_marshallIn(SFc2_vC_3ph_MR2InstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId, real_T c2_y[6]);
...
static const mxArray *c2_w_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_tb_emlrt_marshallIn(SFc2_vC_3ph_MR2InstanceStruct *chartInstance,
  const mxArray *c2_b_omega_k, const char_T *c2_identifier, real_T c2_y[6]);
static void c2_ub_emlrt_marshallIn(SFc2_vC_3ph_MR2InstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId, real_T c2_y[6]);
...
static const mxArray *c2_x_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_vb_emlrt_marshallIn(SFc2_vC_3ph_MR2InstanceStruct *chartInstance,
  const mxArray *c2_b_theta_k, const char_T *c2_identifier, real_T c2_y[6]);
static void c2_wb_emlrt_marshallIn(SFc2_vC_3ph_MR2InstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId, real_T c2_y[6]);
...
static const mxArray *c2_y_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_xb_emlrt_marshallIn(SFc2_vC_3ph_MR2InstanceStruct
  *chartInstance, const mxArray *c2_m, const char_T *c2_identifier);
static real_T c2_yb_emlrt_marshallIn(SFc2_vC_3ph_MR2InstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
...
static const mxArray *c2_ab_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_ac_emlrt_marshallIn(SFc2_vC_3ph_MR2InstanceStruct *chartInstance,
  const mxArray *c2_theta_alpha, const char_T *c2_identifier, real_T c2_y[6]);
static void c2_bc_emlrt_marshallIn(SFc2_vC_3ph_MR2InstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId, real_T c2_y[6]);
...
static void c2_eml_int_forloop_overflow_check(SFc2_vC_3ph_MR2InstanceStruct
  *chartInstance);
static void c2_b_eml_scalar_eg(SFc2_vC_3ph_MR2InstanceStruct *chartInstance);
static real_T c2_mpower(SFc2_vC_3ph_MR2InstanceStruct *chartInstance, real_T
  c2_a);
static void c2_c_eml_scalar_eg(SFc2_vC_3ph_MR2InstanceStruct *chartInstance);
static void c2_d_eml_scalar_eg(SFc2_vC_3ph_MR2InstanceStruct *chartInstance);
...
static const mxArray *c2_bb_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_cc_emlrt_marshallIn(SFc2_vC_3ph_MR2InstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_bb_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_dc_emlrt_marshallIn(SFc2_vC_3ph_MR2InstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_vC_3ph_MR2, const char_T
  *c2_identifier);
static uint8_T c2_ec_emlrt_marshallIn(SFc2_vC_3ph_MR2InstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_b_sqrt(SFc2_vC_3ph_MR2InstanceStruct *chartInstance, real_T *c2_x);
  ...
  chartInstance)
{
  ...
  c2_r_hoistedGlobal = chartInstance->c2_is_active_c2_vC_3ph_MR2;
  ...
  *chartInstance, const mxArray *c2_st)
{
  ...
  *c2_up_alpha = c2_xb_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
  ...
  chartInstance->c2_is_active_c2_vC_3ph_MR2 = c2_dc_emlrt_marshallIn
...
static void sf_c2_vC_3ph_MR2(SFc2_vC_3ph_MR2InstanceStruct *chartInstance)
{
  ...
  for (c2_i20 = 0; c2_i20 < 6; c2_i20++) {
    _SFD_DATA_RANGE_CHECK((*c2_theta_alpha)[c2_i20], 5U);
  }

  _SFD_DATA_RANGE_CHECK(*c2_t, 6U);
  ...
  *chartInstance)
{
  ...
  real_T c2_m;
  int32_T c2_i21;
  static real_T c2_dv10[6] = { 0.9704, -1.0143, 2.2791, 16.1382, 0.0, 0.0 };
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(805518562U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2134293200U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1818121943U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(439598950U);
}
...
mxArray *sf_c2_vC_3ph_MR2_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("BKmunogJSgy5MpCs6hIfLE");
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,6465);
        ...
        _SFD_CV_INIT_EML_IF(0,1,24,5292,5302,5391,5483);
        _SFD_CV_INIT_EML_IF(0,1,25,5848,5858,5966,6085);
...

        {
          ...
          _SFD_SET_DATA_VALUE_PTR(6U, c2_t);
...
static void mdlSetWorkWidths_c2_vC_3ph_MR2(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(2755349887U));
  ssSetChecksum1(S,(2354480707U));
  ssSetChecksum2(S,(1952500506U));
  ssSetChecksum3(S,(638043968U));
