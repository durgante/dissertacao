...
static void c3_ab_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static void c3_info_helper(c3_ResolvedFunctionInfo c3_info[52]);
  ...
  *chartInstance)
{
  ...
  real_T c3_m;
  int32_T c3_i21;
  static real_T c3_dv10[6] = { 0.9704, -1.0277, 2.2629, 16.1727, 0.0, 0.0 };
  ...
  c3_b_b = c3_h_hoistedGlobal - c3_i_hoistedGlobal;
  c3_b_y = 3.0 * c3_b_b;
  ...
  c3_n_hoistedGlobal = chartInstance->c3_v_k_1;
  c3_f_b = c3_n_hoistedGlobal;
  c3_f_y = 0.4 * c3_f_b;
  c3_o_hoistedGlobal = chartInstance->c3_v_k_2;
  c3_g_b = c3_o_hoistedGlobal;
  c3_g_y = 0.040000000000000008 * c3_g_b;
  c3_p_hoistedGlobal = chartInstance->c3_u_k_2;
  c3_h_b = c3_p_hoistedGlobal;
  ...
  if (CV_EML_IF(0, 1, 24, c3_flag == 1.0)) {
    ...
    c3_m2_k = (c3_j_y + c3_mpower(chartInstance, c3_e2_k)) +
      chartInstance->c3_m2;
  } else {
    ...
    for (c3_g_k = 1; c3_g_k < 7; c3_g_k++) {
      c3_h_k = c3_g_k;
      c3_k_y += c3_a[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK
        ("", (real_T)c3_h_k), 1, 6, 1, 0) - 1] *
        c3_j_hoistedGlobal[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
        _SFD_INTEGER_CHECK("", (real_T)c3_h_k), 1, 6, 1, 0) - 1];
    }

    c3_m2_k = (c3_k_y + c3_mpower(chartInstance, c3_e2_k)) +
      chartInstance->c3_m2;
  }
  ...
  for (c3_i58 = 0; c3_i58 < 6; c3_i58++) {
    for (c3_i59 = 0; c3_i59 < 6; c3_i59++) {
      c3_l_y[c3_i59 + c3_i57] = c3_g_hoistedGlobal[c3_i59] * c3_a[c3_i58];
    }
  ...
  for (c3_i61 = 0; c3_i61 < 6; c3_i61++) {
    ...
    for (c3_i63 = 0; c3_i63 < 6; c3_i63++) {
      c3_m_y[c3_i62 + c3_i61] = 0.0;
      c3_i64 = 0;
      for (c3_i65 = 0; c3_i65 < 6; c3_i65++) {
        c3_m_y[c3_i62 + c3_i61] += c3_l_y[c3_i64 + c3_i61] *
  ...
  for (c3_i66 = 0; c3_i66 < 36; c3_i66++) {
    c3_m_y[c3_i66] /= c3_o_y;
  }

  for (c3_i67 = 0; c3_i67 < 36; c3_i67++) {
    chartInstance->c3_P[c3_i67] = c3_r_hoistedGlobal[c3_i67] - c3_m_y[c3_i67];
  }
  ...
  c3_j_b = c3_mpower(chartInstance, c3_e2_k);
  c3_p_y = c3_c_a * c3_j_b;
  c3_A = c3_p_y;
  ...
  c3_b_x = c3_x;
  c3_r_y = c3_q_y;
  c3_s_y = c3_b_x / c3_r_y;
  chartInstance->c3_gama2 = c3_t_hoistedGlobal - c3_s_y;
  ...
  c3_f_x = c3_e_x;
  c3_bb_y = c3_ab_y;
  c3_cb_y = c3_f_x / c3_bb_y;
  chartInstance->c3_rho_k = c3_v_hoistedGlobal - c3_cb_y;
  ...
  if (CV_EML_IF(0, 1, 25, c3_flag == 1.0)) {
    ...
    c3_n_b = c3_w_hoistedGlobal - 1.0;
    c3_db_y = 0.8 * c3_n_b;
    chartInstance->c3_m2 = ((c3_db_y + c3_abs(chartInstance, c3_u_k)) + c3_abs
      (chartInstance, c3_i2_k)) + 1.0;
  } else {
    _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 277);
    c3_x_hoistedGlobal = chartInstance->c3_m2;
    c3_o_b = c3_x_hoistedGlobal - 1.0;
    c3_eb_y = 0.8 * c3_o_b;
    chartInstance->c3_m2 = ((c3_eb_y + c3_abs(chartInstance, c3_u_k)) + c3_abs
      (chartInstance, c3_i2_k)) + 1.0;
  }
  ...
  c3_p_b = c3_f_hoistedGlobal[0];
  c3_fb_y = 0.0 * c3_p_b;
  c3_q_b = c3_u_k;
  c3_gb_y = c3_q_b;
  chartInstance->c3_omega_k[0] = c3_fb_y + c3_gb_y;
  ...
  c3_r_b = c3_f_hoistedGlobal[1];
  c3_hb_y = 0.0 * c3_r_b;
  c3_s_b = c3_i2_k;
  c3_ib_y = c3_s_b;
  chartInstance->c3_omega_k[1] = c3_hb_y + c3_ib_y;
...
const mxArray *sf_c3_vC_3ph_MR2_get_eml_resolved_functions_info(void)
{
  ...
  c3_ResolvedFunctionInfo c3_info[52];
  ...
  sf_mex_assign(&c3_m0, sf_mex_createstruct("nameCaptureInfo", 1, 52), FALSE);
  for (c3_i128 = 0; c3_i128 < 52; c3_i128++) {
...
static void c3_info_helper(c3_ResolvedFunctionInfo c3_info[52])
{
  ...
  c3_info[30].fileTimeLo = 1299080374U;
  ...
  c3_info[31].resolved =
    "[ILXE]C:/Program Files/MATLAB/R2012a/toolbox/eml/lib/matlab/eml/eml_scalar_eg.m";
  c3_info[31].fileTimeLo = 1286825996U;
  ...
  c3_info[32].resolved =
    "[ILXE]C:/Program Files/MATLAB/R2012a/toolbox/eml/lib/matlab/eml/eml_index_class.m";
  c3_info[32].fileTimeLo = 1286825978U;
  ...
  c3_info[33].fileTimeLo = 1286825978U;
  ...
  c3_info[34].resolved =
    "[ILXE]C:/Program Files/MATLAB/R2012a/toolbox/eml/lib/matlab/eml/eml_index_class.m";
  c3_info[34].fileTimeLo = 1286825978U;
  ...
  c3_info[35].fileTimeLo = 1286825980U;
  ...
  c3_info[46].resolved =
    "[ILXE]C:/Program Files/MATLAB/R2012a/toolbox/eml/lib/matlab/eml/blas/eml_blas_inline.m";
  c3_info[46].fileTimeLo = 1299080368U;
  ...
  c3_info[47].resolved =
    "[ILXE]C:/Program Files/MATLAB/R2012a/toolbox/eml/lib/matlab/ops/mtimes.m";
  c3_info[47].fileTimeLo = 1289523292U;
  ...
  c3_info[49].fileTimeLo = 1299080374U;
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1152368110U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1503855851U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2005341504U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3497395121U);
}
...
mxArray *sf_c3_vC_3ph_MR2_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("IlGaheUMu4yOyWf6o1OAjG");
...
static const mxArray *sf_get_sim_state_info_c3_vC_3ph_MR2(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x10'type','srcId','name','auxInfo'{{M[1],M[16],T\"m\",},{M[1],M[15],T\"theta_beta\",},{M[1],M[5],T\"up_beta\",},{M[4],M[0],T\"P\",S'l','i','p'{{M1x2[3369 3370],M[0],}}},{M[4],M[0],T\"eta_k_1\",S'l','i','p'{{M1x2[2294 2301],M[0],}}},{M[4],M[0],T\"eta_k_2\",S'l','i','p'{{M1x2[2383 2390],M[0],}}},{M[4],M[0],T\"eta_k_3\",S'l','i','p'{{M1x2[2472 2479],M[0],}}},{M[4],M[0],T\"gama2\",S'l','i','p'{{M1x2[4572 4577],M[0],}}},{M[4],M[0],T\"i2m_k_1\",S'l','i','p'{{M1x2[2561 2568],M[0],}}},{M[4],M[0],T\"i2m_k_2\",S'l','i','p'{{M1x2[2621 2628],M[0],}}}}",
    "100 S1x10'type','srcId','name','auxInfo'{{M[4],M[0],T\"i2m_k_3\",S'l','i','p'{{M1x2[2681 2688],M[0],}}},{M[4],M[0],T\"i2ref_k_1\",S'l','i','p'{{M1x2[2741 2750],M[0],}}},{M[4],M[0],T\"i2ref_k_2\",S'l','i','p'{{M1x2[2807 2816],M[0],}}},{M[4],M[0],T\"i2ref_k_3\",S'l','i','p'{{M1x2[2873 2882],M[0],}}},{M[4],M[0],T\"m2\",S'l','i','p'{{M1x2[3159 3161],M[0],}}},{M[4],M[0],T\"omega_k\",S'l','i','p'{{M1x2[1920 1927],M[0],}}},{M[4],M[0],T\"omega_k_1\",S'l','i','p'{{M1x2[2009 2018],M[0],}}},{M[4],M[0],T\"omega_k_2\",S'l','i','p'{{M1x2[2104 2113],M[0],}}},{M[4],M[0],T\"omega_k_3\",S'l','i','p'{{M1x2[2199 2208],M[0],}}},{M[4],M[0],T\"rho_k\",S'l','i','p'{{M1x2[3101 3106],M[0],}}}}",
    "100 S1x8'type','srcId','name','auxInfo'{{M[4],M[0],T\"theta_k\",S'l','i','p'{{M1x2[1196 1203],M[0],}}},{M[4],M[0],T\"u_k_1\",S'l','i','p'{{M1x2[3261 3266],M[0],}}},{M[4],M[0],T\"u_k_2\",S'l','i','p'{{M1x2[3315 3320],M[0],}}},{M[4],M[0],T\"v_k_1\",S'l','i','p'{{M1x2[2939 2944],M[0],}}},{M[4],M[0],T\"v_k_2\",S'l','i','p'{{M1x2[2993 2998],M[0],}}},{M[4],M[0],T\"v_k_3\",S'l','i','p'{{M1x2[3047 3052],M[0],}}},{M[4],M[0],T\"vc_k_1\",S'l','i','p'{{M1x2[3204 3210],M[0],}}},{M[8],M[0],T\"is_active_c3_vC_3ph_MR2\",}}"
  };
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,6461);
        _SFD_CV_INIT_EML_IF(0,1,0,1205,1224,-1,1907);
        _SFD_CV_INIT_EML_IF(0,1,1,1929,1948,-1,1996);
        _SFD_CV_INIT_EML_IF(0,1,2,2020,2041,-1,2091);
        _SFD_CV_INIT_EML_IF(0,1,3,2115,2136,-1,2186);
        _SFD_CV_INIT_EML_IF(0,1,4,2210,2231,-1,2281);
        _SFD_CV_INIT_EML_IF(0,1,5,2303,2322,-1,2370);
        _SFD_CV_INIT_EML_IF(0,1,6,2392,2411,-1,2459);
        _SFD_CV_INIT_EML_IF(0,1,7,2481,2500,-1,2548);
        _SFD_CV_INIT_EML_IF(0,1,8,2570,2589,-1,2608);
        _SFD_CV_INIT_EML_IF(0,1,9,2630,2649,-1,2668);
        _SFD_CV_INIT_EML_IF(0,1,10,2690,2709,-1,2728);
        _SFD_CV_INIT_EML_IF(0,1,11,2752,2773,-1,2794);
        _SFD_CV_INIT_EML_IF(0,1,12,2818,2839,-1,2860);
        _SFD_CV_INIT_EML_IF(0,1,13,2884,2905,-1,2926);
        _SFD_CV_INIT_EML_IF(0,1,14,2946,2963,-1,2980);
        _SFD_CV_INIT_EML_IF(0,1,15,3000,3017,-1,3034);
        _SFD_CV_INIT_EML_IF(0,1,16,3054,3071,-1,3088);
        _SFD_CV_INIT_EML_IF(0,1,17,3108,3125,-1,3146);
        _SFD_CV_INIT_EML_IF(0,1,18,3163,3177,-1,3191);
        _SFD_CV_INIT_EML_IF(0,1,19,3212,3230,-1,3248);
        _SFD_CV_INIT_EML_IF(0,1,20,3268,3285,-1,3302);
        _SFD_CV_INIT_EML_IF(0,1,21,3322,3339,-1,3356);
        _SFD_CV_INIT_EML_IF(0,1,22,3372,3385,-1,4559);
        _SFD_CV_INIT_EML_IF(0,1,23,4579,4596,-1,4646);
        _SFD_CV_INIT_EML_IF(0,1,24,5289,5299,5388,5480);
        _SFD_CV_INIT_EML_IF(0,1,25,5844,5854,5962,6081);
...
static void mdlSetWorkWidths_c3_vC_3ph_MR2(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(4152989947U));
  ssSetChecksum1(S,(2592536681U));
  ssSetChecksum2(S,(2211806600U));
  ssSetChecksum3(S,(2008208026U));
