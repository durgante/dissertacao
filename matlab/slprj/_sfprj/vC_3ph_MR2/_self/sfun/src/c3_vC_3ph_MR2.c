...
static const char * c3_debug_family_names[42] = { "kp_kd", "Kp", "p1", "p2",
...
static const mxArray *c3_b_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static real_T c3_c_emlrt_marshallIn(SFc3_vC_3ph_MR2InstanceStruct *chartInstance,
  const mxArray *c3_b_u_k_1, const char_T *c3_identifier);
static real_T c3_d_emlrt_marshallIn(SFc3_vC_3ph_MR2InstanceStruct *chartInstance,
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
...
static const mxArray *c3_l_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static void c3_w_emlrt_marshallIn(SFc3_vC_3ph_MR2InstanceStruct *chartInstance,
  const mxArray *c3_b_eta_k_2, const char_T *c3_identifier, real_T c3_y[6]);
static void c3_x_emlrt_marshallIn(SFc3_vC_3ph_MR2InstanceStruct *chartInstance,
...
static const mxArray *c3_m_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static void c3_y_emlrt_marshallIn(SFc3_vC_3ph_MR2InstanceStruct *chartInstance,
  const mxArray *c3_b_eta_k_1, const char_T *c3_identifier, real_T c3_y[6]);
static void c3_ab_emlrt_marshallIn(SFc3_vC_3ph_MR2InstanceStruct *chartInstance,
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId, real_T c3_y[6]);
...
static const mxArray *c3_n_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static void c3_bb_emlrt_marshallIn(SFc3_vC_3ph_MR2InstanceStruct *chartInstance,
  const mxArray *c3_b_omega_k_2, const char_T *c3_identifier, real_T c3_y[6]);
static void c3_cb_emlrt_marshallIn(SFc3_vC_3ph_MR2InstanceStruct *chartInstance,
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId, real_T c3_y[6]);
...
static const mxArray *c3_o_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static void c3_db_emlrt_marshallIn(SFc3_vC_3ph_MR2InstanceStruct *chartInstance,
  const mxArray *c3_b_omega_k_1, const char_T *c3_identifier, real_T c3_y[6]);
static void c3_eb_emlrt_marshallIn(SFc3_vC_3ph_MR2InstanceStruct *chartInstance,
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId, real_T c3_y[6]);
...
static const mxArray *c3_p_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static void c3_fb_emlrt_marshallIn(SFc3_vC_3ph_MR2InstanceStruct *chartInstance,
  const mxArray *c3_b_omega_k, const char_T *c3_identifier, real_T c3_y[6]);
static void c3_gb_emlrt_marshallIn(SFc3_vC_3ph_MR2InstanceStruct *chartInstance,
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId, real_T c3_y[6]);
...
static const mxArray *c3_s_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static real_T c3_lb_emlrt_marshallIn(SFc3_vC_3ph_MR2InstanceStruct
  *chartInstance, const mxArray *c3_up_beta, const char_T *c3_identifier);
static real_T c3_mb_emlrt_marshallIn(SFc3_vC_3ph_MR2InstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_s_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static void c3_info_helper(c3_ResolvedFunctionInfo c3_info[29]);
...
static const mxArray *c3_t_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static int32_T c3_nb_emlrt_marshallIn(SFc3_vC_3ph_MR2InstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_t_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static uint8_T c3_ob_emlrt_marshallIn(SFc3_vC_3ph_MR2InstanceStruct
  *chartInstance, const mxArray *c3_b_is_active_c3_vC_3ph_MR2, const char_T
  *c3_identifier);
static uint8_T c3_pb_emlrt_marshallIn(SFc3_vC_3ph_MR2InstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
  ...
  chartInstance)
{
  ...
  c3_st = NULL;
  c3_y = NULL;
  sf_mex_assign(&c3_y, sf_mex_createcellarray(20), FALSE);
  ...
  c3_l_hoistedGlobal = chartInstance->c3_vc_k_1;
  ...
  c3_m_hoistedGlobal = chartInstance->c3_is_active_c3_vC_3ph_MR2;
  c3_t_u = c3_m_hoistedGlobal;
  c3_u_y = NULL;
  ...
  *chartInstance, const mxArray *c3_st)
{
  ...
  c3_jb_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 0)),
    "theta_beta", c3_dv0);
  for (c3_i7 = 0; c3_i7 < 6; c3_i7++) {
    (*c3_theta_beta)[c3_i7] = c3_dv0[c3_i7];
  }

  *c3_up_beta = c3_lb_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c3_u, 1)), "up_beta");
  c3_y_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 2)),
                        "eta_k_1", c3_dv1);
  for (c3_i8 = 0; c3_i8 < 6; c3_i8++) {
    chartInstance->c3_eta_k_1[c3_i8] = c3_dv1[c3_i8];
  }

  c3_w_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 3)),
                        "eta_k_2", c3_dv2);
  for (c3_i9 = 0; c3_i9 < 6; c3_i9++) {
    chartInstance->c3_eta_k_2[c3_i9] = c3_dv2[c3_i9];
  }

  chartInstance->c3_i2m_k_1 = c3_u_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c3_u, 4)), "i2m_k_1");
  chartInstance->c3_i2m_k_2 = c3_s_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c3_u, 5)), "i2m_k_2");
  chartInstance->c3_i2ref_k_1 = c3_q_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c3_u, 6)), "i2ref_k_1");
  chartInstance->c3_i2ref_k_2 = c3_o_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c3_u, 7)), "i2ref_k_2");
  chartInstance->c3_m2 = c3_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c3_u, 8)), "m2");
  c3_fb_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 9)),
    "omega_k", c3_dv3);
  for (c3_i10 = 0; c3_i10 < 6; c3_i10++) {
    chartInstance->c3_omega_k[c3_i10] = c3_dv3[c3_i10];
  }

  c3_db_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 10)),
    "omega_k_1", c3_dv4);
  for (c3_i11 = 0; c3_i11 < 6; c3_i11++) {
    chartInstance->c3_omega_k_1[c3_i11] = c3_dv4[c3_i11];
  }

  c3_bb_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 11)),
    "omega_k_2", c3_dv5);
  for (c3_i12 = 0; c3_i12 < 6; c3_i12++) {
    chartInstance->c3_omega_k_2[c3_i12] = c3_dv5[c3_i12];
  }

  chartInstance->c3_rho_k = c3_i_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c3_u, 12)), "rho_k");
  c3_hb_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 13)),
    "theta_k", c3_dv6);
  ...
  chartInstance->c3_v_k_1 = c3_m_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c3_u, 16)), "v_k_1");
  chartInstance->c3_v_k_2 = c3_k_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c3_u, 17)), "v_k_2");
  chartInstance->c3_vc_k_1 = c3_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c3_u, 18)), "vc_k_1");
  chartInstance->c3_is_active_c3_vC_3ph_MR2 = c3_ob_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 19)),
  ...
  *chartInstance)
{
  ...
  real_T c3_theta_beta[6];
  int32_T c3_i15;
  static real_T c3_dv7[6] = { 0.9704, -1.0277, 2.2629, 16.1727, 0.0, 0.0 };
  ...
  sf_debug_symbol_scope_add_eml(&c3_kp_kd, 0U, c3_s_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c3_Kp, 1U, c3_s_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c3_p1, 2U, c3_s_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c3_p2, 3U, c3_s_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c3_km, 4U, c3_s_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c3_gamaD, 5U, c3_s_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c3_gama, 6U, c3_s_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c3_delta0, 7U, c3_s_sf_marshallOut);
  sf_debug_symbol_scope_add_eml_importable(&c3_u_k, 8U, c3_s_sf_marshallOut,
    c3_s_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(c3_eta_k, 9U, c3_r_sf_marshallOut,
    c3_r_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_i2m_k, 10U, c3_s_sf_marshallOut,
    c3_s_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_e1_k, 11U, c3_s_sf_marshallOut,
    c3_s_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_v_k, 12U, c3_s_sf_marshallOut,
    c3_s_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_q_k, 13U, c3_s_sf_marshallOut,
    c3_s_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_e2_k, 14U, c3_s_sf_marshallOut,
    c3_s_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_ea_k, 15U, c3_s_sf_marshallOut,
    c3_s_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_m2_k, 16U, c3_s_sf_marshallOut,
    c3_s_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_nargin, 17U, c3_s_sf_marshallOut,
    c3_s_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_nargout, 18U, c3_s_sf_marshallOut,
    c3_s_sf_marshallIn);
  sf_debug_symbol_scope_add_eml(&c3_i2ref_k, 19U, c3_s_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c3_i2_k, 20U, c3_s_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c3_vc_k, 21U, c3_s_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c3_t, 22U, c3_s_sf_marshallOut);
  sf_debug_symbol_scope_add_eml_importable(&c3_up_beta, 23U, c3_s_sf_marshallOut,
    c3_s_sf_marshallIn);
  ...
  sf_debug_symbol_scope_add_eml_importable(&chartInstance->c3_vc_k_1, 39U,
    c3_c_sf_marshallOut, c3_c_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&chartInstance->c3_u_k_1, 40U,
    c3_b_sf_marshallOut, c3_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&chartInstance->c3_u_k_2, 41U,
  ...
  if (CV_EML_IF(0, 1, 14, !chartInstance->c3_vc_k_1_not_empty)) {
  ...
  if (CV_EML_IF(0, 1, 15, !chartInstance->c3_u_k_1_not_empty)) {
  ...
  if (CV_EML_IF(0, 1, 16, !chartInstance->c3_u_k_2_not_empty)) {
  ...
  chartInstance->c3_omega_k[4] = 0.0;
  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 128U);
  chartInstance->c3_omega_k[5] = 0.0;
  ...
  c3_b = c3_u_k - c3_vc_k;
  c3_y = 3.0 * c3_b;
  c3_g_hoistedGlobal = chartInstance->c3_u_k_1;
  c3_h_hoistedGlobal = chartInstance->c3_vc_k_1;
  c3_b_b = c3_g_hoistedGlobal - c3_h_hoistedGlobal;
  c3_b_y = 3.0 * c3_b_b;
  c3_up_beta = c3_y - c3_b_y;
  ...
  for (c3_i28 = 0; c3_i28 < 6; c3_i28++) {
    c3_i_hoistedGlobal[c3_i28] = chartInstance->c3_omega_k_2[c3_i28];
  }

  for (c3_i29 = 0; c3_i29 < 6; c3_i29++) {
    c3_i_hoistedGlobal[c3_i29] *= 0.64000000000000012;
  }

  for (c3_i30 = 0; c3_i30 < 6; c3_i30++) {
    c3_eta_k[c3_i30] = (c3_e_hoistedGlobal[c3_i30] - c3_f_hoistedGlobal[c3_i30])
      + c3_i_hoistedGlobal[c3_i30];
  }

  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 137U);
  c3_j_hoistedGlobal = chartInstance->c3_i2m_k_1;
  c3_c_b = c3_j_hoistedGlobal;
  c3_c_y = 0.4 * c3_c_b;
  c3_k_hoistedGlobal = chartInstance->c3_i2m_k_2;
  c3_d_b = c3_k_hoistedGlobal;
  c3_d_y = 0.040000000000000008 * c3_d_b;
  c3_l_hoistedGlobal = chartInstance->c3_i2ref_k_2;
  c3_e_b = c3_l_hoistedGlobal;
  c3_e_y = 0.64000000000000012 * c3_e_b;
  c3_i2m_k = (c3_c_y - c3_d_y) + c3_e_y;
  ...
  c3_f_b = c3_m_hoistedGlobal;
  c3_f_y = 0.4 * c3_f_b;
  c3_n_hoistedGlobal = chartInstance->c3_v_k_2;
  c3_g_b = c3_n_hoistedGlobal;
  c3_g_y = 0.040000000000000008 * c3_g_b;
  c3_o_hoistedGlobal = chartInstance->c3_u_k_2;
  c3_h_b = c3_o_hoistedGlobal;
  c3_h_y = 0.64000000000000012 * c3_h_b;
  c3_v_k = (c3_f_y - c3_g_y) + c3_h_y;
  ...
  c3_p_hoistedGlobal = chartInstance->c3_rho_k;
  c3_b_a = c3_p_hoistedGlobal;
  c3_i_b = c3_e2_k;
  c3_i_y = c3_b_a * c3_i_b;
  c3_ea_k = c3_e1_k + c3_i_y;
  ...
  for (c3_e_k = 1; c3_e_k < 7; c3_e_k++) {
    c3_f_k = c3_e_k;
    c3_j_y += c3_a[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK(
      "", (real_T)c3_f_k), 1, 6, 1, 0) - 1] *
      c3_f_hoistedGlobal[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
      _SFD_INTEGER_CHECK("", (real_T)c3_f_k), 1, 6, 1, 0) - 1];
  }

  c3_m2_k = (c3_j_y + c3_mpower(chartInstance, c3_e2_k)) + chartInstance->c3_m2;
  ...
  c3_d_x = c3_c_x;
  c3_r_y = c3_q_y;
  c3_s_y = c3_d_x / c3_r_y;
  chartInstance->c3_rho_k = c3_q_hoistedGlobal - c3_s_y;
  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 161U);
  c3_r_hoistedGlobal = chartInstance->c3_m2;
  c3_m_b = c3_r_hoistedGlobal - 1.0;
  c3_t_y = 0.8 * c3_m_b;
  chartInstance->c3_m2 = ((c3_t_y + c3_abs(chartInstance, c3_u_k)) + c3_abs
  ...
  c3_n_b = c3_e_hoistedGlobal[0];
  c3_u_y = 0.0 * c3_n_b;
  c3_o_b = c3_u_k;
  c3_v_y = c3_o_b;
  chartInstance->c3_omega_k[0] = c3_u_y + c3_v_y;
  ...
  c3_p_b = c3_e_hoistedGlobal[1];
  c3_w_y = 0.0 * c3_p_b;
  c3_q_b = c3_i2_k;
  c3_x_y = c3_q_b;
  chartInstance->c3_omega_k[1] = c3_w_y + c3_x_y;
  ...
  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, -184);
  ...
  const mxArray *c3_b_vc_k_1, const char_T *c3_identifier)
{
  ...
  c3_thisId.fIdentifier = c3_identifier;
  c3_thisId.fParent = NULL;
  c3_y = c3_f_emlrt_marshallIn(chartInstance, sf_mex_dup(c3_b_vc_k_1),
    &c3_thisId);
  ...
  const mxArray *c3_b_m2, const char_T *c3_identifier)
{
  ...
  c3_thisId.fIdentifier = c3_identifier;
  c3_thisId.fParent = NULL;
  c3_y = c3_h_emlrt_marshallIn(chartInstance, sf_mex_dup(c3_b_m2), &c3_thisId);
  ...
  const mxArray *c3_b_rho_k, const char_T *c3_identifier)
{
  ...
  c3_thisId.fIdentifier = c3_identifier;
  c3_thisId.fParent = NULL;
  c3_y = c3_j_emlrt_marshallIn(chartInstance, sf_mex_dup(c3_b_rho_k), &c3_thisId);
  ...
  const mxArray *c3_b_v_k_2, const char_T *c3_identifier)
{
  ...
  c3_thisId.fIdentifier = c3_identifier;
  c3_thisId.fParent = NULL;
  c3_y = c3_l_emlrt_marshallIn(chartInstance, sf_mex_dup(c3_b_v_k_2), &c3_thisId);
  ...
  const mxArray *c3_b_v_k_1, const char_T *c3_identifier)
{
  ...
  c3_thisId.fIdentifier = c3_identifier;
  c3_thisId.fParent = NULL;
  c3_y = c3_n_emlrt_marshallIn(chartInstance, sf_mex_dup(c3_b_v_k_1), &c3_thisId);
  ...
  const mxArray *c3_b_i2ref_k_2, const char_T *c3_identifier)
{
  ...
  c3_thisId.fIdentifier = c3_identifier;
  c3_thisId.fParent = NULL;
  c3_y = c3_p_emlrt_marshallIn(chartInstance, sf_mex_dup(c3_b_i2ref_k_2),
    &c3_thisId);
  ...
  const mxArray *c3_b_i2ref_k_1, const char_T *c3_identifier)
{
  ...
  c3_thisId.fIdentifier = c3_identifier;
  c3_thisId.fParent = NULL;
  c3_y = c3_r_emlrt_marshallIn(chartInstance, sf_mex_dup(c3_b_i2ref_k_1),
    &c3_thisId);
  ...
  const mxArray *c3_b_i2m_k_2, const char_T *c3_identifier)
{
  ...
  c3_thisId.fIdentifier = c3_identifier;
  c3_thisId.fParent = NULL;
  c3_y = c3_t_emlrt_marshallIn(chartInstance, sf_mex_dup(c3_b_i2m_k_2),
    &c3_thisId);
  ...
  const mxArray *c3_b_i2m_k_1, const char_T *c3_identifier)
{
  ...
  c3_thisId.fIdentifier = c3_identifier;
  c3_thisId.fParent = NULL;
  c3_y = c3_v_emlrt_marshallIn(chartInstance, sf_mex_dup(c3_b_i2m_k_1),
    &c3_thisId);
  ...
  const mxArray *c3_b_eta_k_2, const char_T *c3_identifier, real_T c3_y[6])
{
  ...
  c3_thisId.fIdentifier = c3_identifier;
  c3_thisId.fParent = NULL;
  c3_x_emlrt_marshallIn(chartInstance, sf_mex_dup(c3_b_eta_k_2), &c3_thisId,
                        c3_y);
  ...
  const mxArray *c3_b_eta_k_1, const char_T *c3_identifier, real_T c3_y[6])
{
  ...
  c3_thisId.fIdentifier = c3_identifier;
  c3_thisId.fParent = NULL;
  c3_ab_emlrt_marshallIn(chartInstance, sf_mex_dup(c3_b_eta_k_1), &c3_thisId,
    c3_y);
  ...
  const mxArray *c3_b_omega_k_2, const char_T *c3_identifier, real_T c3_y[6])
{
  ...
  c3_thisId.fIdentifier = c3_identifier;
  c3_thisId.fParent = NULL;
  c3_cb_emlrt_marshallIn(chartInstance, sf_mex_dup(c3_b_omega_k_2), &c3_thisId,
    c3_y);
  ...
  const mxArray *c3_b_omega_k_1, const char_T *c3_identifier, real_T c3_y[6])
{
  ...
  c3_thisId.fIdentifier = c3_identifier;
  c3_thisId.fParent = NULL;
  c3_eb_emlrt_marshallIn(chartInstance, sf_mex_dup(c3_b_omega_k_1), &c3_thisId,
    c3_y);
  ...
  const mxArray *c3_b_omega_k, const char_T *c3_identifier, real_T c3_y[6])
{
  ...
  c3_thisId.fIdentifier = c3_identifier;
  c3_thisId.fParent = NULL;
  c3_gb_emlrt_marshallIn(chartInstance, sf_mex_dup(c3_b_omega_k), &c3_thisId,
    c3_y);
  ...
  const mxArray *c3_b_theta_k, const char_T *c3_identifier, real_T c3_y[6])
{
  ...
  c3_thisId.fIdentifier = c3_identifier;
  c3_thisId.fParent = NULL;
  c3_ib_emlrt_marshallIn(chartInstance, sf_mex_dup(c3_b_theta_k), &c3_thisId,
    c3_y);
  ...
  const mxArray *c3_theta_beta, const char_T *c3_identifier, real_T c3_y[6])
{
  ...
  c3_thisId.fIdentifier = c3_identifier;
  c3_thisId.fParent = NULL;
  c3_kb_emlrt_marshallIn(chartInstance, sf_mex_dup(c3_theta_beta), &c3_thisId,
    c3_y);
  ...
  *chartInstance, const mxArray *c3_up_beta, const char_T *c3_identifier)
{
  ...
  c3_thisId.fIdentifier = c3_identifier;
  c3_thisId.fParent = NULL;
  c3_y = c3_mb_emlrt_marshallIn(chartInstance, sf_mex_dup(c3_up_beta),
    &c3_thisId);
...
const mxArray *sf_c3_vC_3ph_MR2_get_eml_resolved_functions_info(void)
{
  ...
  c3_ResolvedFunctionInfo c3_info[29];
  ...
  sf_mex_assign(&c3_m0, sf_mex_createstruct("nameCaptureInfo", 1, 29), FALSE);
  for (c3_i77 = 0; c3_i77 < 29; c3_i77++) {
...
static void c3_info_helper(c3_ResolvedFunctionInfo c3_info[29])
{
  ...
  c3_info[4].fileTimeLo = 1286825978U;
  ...
  c3_info[10].name = "eml_refblas_xdot";
  ...
  c3_info[11].context =
    "[ILXE]C:/Program Files/MATLAB/R2012a/toolbox/eml/lib/matlab/eml/blas/refblas/eml_refblas_xdot.m";
  c3_info[11].name = "eml_refblas_xdotx";
  ...
  c3_info[11].fileTimeLo = 1299080374U;
  ...
  c3_info[12].resolved =
    "[ILXE]C:/Program Files/MATLAB/R2012a/toolbox/eml/lib/matlab/eml/eml_scalar_eg.m";
  c3_info[12].fileTimeLo = 1286825996U;
  ...
  c3_info[15].resolved =
    "[ILXE]C:/Program Files/MATLAB/R2012a/toolbox/eml/lib/matlab/eml/eml_index_class.m";
  c3_info[15].fileTimeLo = 1286825978U;
  ...
  c3_info[16].fileTimeLo = 1286825980U;
  ...
  c3_info[18].context =
    "[ILXE]C:/Program Files/MATLAB/R2012a/toolbox/eml/lib/matlab/eml/blas/refblas/eml_refblas_xdotx.m";
  c3_info[18].name = "eml_index_plus";
  ...
  c3_info[22].fileTimeLo = 1286826042U;
  ...
  c3_info[23].fileTimeLo = 1307658440U;
  ...
  c3_info[24].resolved =
    "[ILXE]C:/Program Files/MATLAB/R2012a/toolbox/eml/lib/matlab/eml/eml_scalar_eg.m";
  c3_info[24].fileTimeLo = 1286825996U;
  ...
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData)
{
  ...
  c3_thisId.fIdentifier = c3_identifier;
  c3_thisId.fParent = NULL;
  c3_y = c3_nb_emlrt_marshallIn(chartInstance, sf_mex_dup(c3_b_sfEvent),
    &c3_thisId);
  ...
  *c3_identifier)
{
  ...
  c3_thisId.fIdentifier = c3_identifier;
  c3_thisId.fParent = NULL;
  c3_y = c3_pb_emlrt_marshallIn(chartInstance, sf_mex_dup
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(4113477824U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2045372169U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(4062397146U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3086054655U);
}
...
mxArray *sf_c3_vC_3ph_MR2_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("vyu937tYwjs76yhOUxiPwG");
...
static const mxArray *sf_get_sim_state_info_c3_vC_3ph_MR2(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x10'type','srcId','name','auxInfo'{{M[1],M[15],T\"theta_beta\",},{M[1],M[5],T\"up_beta\",},{M[4],M[0],T\"eta_k_1\",S'l','i','p'{{M1x2[867 874],M[0],}}},{M[4],M[0],T\"eta_k_2\",S'l','i','p'{{M1x2[956 963],M[0],}}},{M[4],M[0],T\"i2m_k_1\",S'l','i','p'{{M1x2[1045 1052],M[0],}}},{M[4],M[0],T\"i2m_k_2\",S'l','i','p'{{M1x2[1105 1112],M[0],}}},{M[4],M[0],T\"i2ref_k_1\",S'l','i','p'{{M1x2[1165 1174],M[0],}}},{M[4],M[0],T\"i2ref_k_2\",S'l','i','p'{{M1x2[1231 1240],M[0],}}},{M[4],M[0],T\"m2\",S'l','i','p'{{M1x2[1463 1465],M[0],}}},{M[4],M[0],T\"omega_k\",S'l','i','p'{{M1x2[588 595],M[0],}}}}",
    "100 S1x10'type','srcId','name','auxInfo'{{M[4],M[0],T\"omega_k_1\",S'l','i','p'{{M1x2[677 686],M[0],}}},{M[4],M[0],T\"omega_k_2\",S'l','i','p'{{M1x2[772 781],M[0],}}},{M[4],M[0],T\"rho_k\",S'l','i','p'{{M1x2[1405 1410],M[0],}}},{M[4],M[0],T\"theta_k\",S'l','i','p'{{M1x2[489 496],M[0],}}},{M[4],M[0],T\"u_k_1\",S'l','i','p'{{M1x2[1565 1570],M[0],}}},{M[4],M[0],T\"u_k_2\",S'l','i','p'{{M1x2[1619 1624],M[0],}}},{M[4],M[0],T\"v_k_1\",S'l','i','p'{{M1x2[1297 1302],M[0],}}},{M[4],M[0],T\"v_k_2\",S'l','i','p'{{M1x2[1351 1356],M[0],}}},{M[4],M[0],T\"vc_k_1\",S'l','i','p'{{M1x2[1508 1514],M[0],}}},{M[8],M[0],T\"is_active_c3_vC_3ph_MR2\",}}"
  };
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,2792);
        _SFD_CV_INIT_EML_IF(0,1,0,498,517,-1,575);
        _SFD_CV_INIT_EML_IF(0,1,1,597,616,-1,664);
        _SFD_CV_INIT_EML_IF(0,1,2,688,709,-1,759);
        _SFD_CV_INIT_EML_IF(0,1,3,783,804,-1,854);
        _SFD_CV_INIT_EML_IF(0,1,4,876,895,-1,943);
        _SFD_CV_INIT_EML_IF(0,1,5,965,984,-1,1032);
        _SFD_CV_INIT_EML_IF(0,1,6,1054,1073,-1,1092);
        _SFD_CV_INIT_EML_IF(0,1,7,1114,1133,-1,1152);
        _SFD_CV_INIT_EML_IF(0,1,8,1176,1197,-1,1218);
        _SFD_CV_INIT_EML_IF(0,1,9,1242,1263,-1,1284);
        _SFD_CV_INIT_EML_IF(0,1,10,1304,1321,-1,1338);
        _SFD_CV_INIT_EML_IF(0,1,11,1358,1375,-1,1392);
        _SFD_CV_INIT_EML_IF(0,1,12,1412,1429,-1,1450);
        _SFD_CV_INIT_EML_IF(0,1,13,1467,1481,-1,1495);
        _SFD_CV_INIT_EML_IF(0,1,14,1516,1534,-1,1552);
        _SFD_CV_INIT_EML_IF(0,1,15,1572,1589,-1,1606);
        _SFD_CV_INIT_EML_IF(0,1,16,1626,1643,-1,1660);
        ...
        _SFD_SET_DATA_COMPILED_PROPS(0,SF_DOUBLE,0,NULL,0,0,0,0.0,1.0,0,0,
          (MexFcnForType)c3_s_sf_marshallOut,(MexInFcnForType)NULL);
        _SFD_SET_DATA_COMPILED_PROPS(1,SF_DOUBLE,0,NULL,0,0,0,0.0,1.0,0,0,
          (MexFcnForType)c3_s_sf_marshallOut,(MexInFcnForType)c3_s_sf_marshallIn);
...
static void mdlSetWorkWidths_c3_vC_3ph_MR2(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(602114453U));
  ssSetChecksum1(S,(3510481098U));
  ssSetChecksum2(S,(2829411244U));
  ssSetChecksum3(S,(1160885324U));
