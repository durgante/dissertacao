...
static void initialize_c4_vC_3ph_MR2(SFc4_vC_3ph_MR2InstanceStruct
  *chartInstance);
static void initialize_params_c4_vC_3ph_MR2(SFc4_vC_3ph_MR2InstanceStruct
  *chartInstance);
static void enable_c4_vC_3ph_MR2(SFc4_vC_3ph_MR2InstanceStruct *chartInstance);
static void disable_c4_vC_3ph_MR2(SFc4_vC_3ph_MR2InstanceStruct *chartInstance);
static void c4_update_debugger_state_c4_vC_3ph_MR2(SFc4_vC_3ph_MR2InstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c4_vC_3ph_MR2(SFc4_vC_3ph_MR2InstanceStruct *
  chartInstance);
static void set_sim_state_c4_vC_3ph_MR2(SFc4_vC_3ph_MR2InstanceStruct
  *chartInstance, const mxArray *c4_st);
static void finalize_c4_vC_3ph_MR2(SFc4_vC_3ph_MR2InstanceStruct *chartInstance);
static void sf_c4_vC_3ph_MR2(SFc4_vC_3ph_MR2InstanceStruct *chartInstance);
static void c4_chartstep_c4_vC_3ph_MR2(SFc4_vC_3ph_MR2InstanceStruct
  *chartInstance);
static void initSimStructsc4_vC_3ph_MR2(SFc4_vC_3ph_MR2InstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c4_machineNumber, uint32_T
  c4_chartNumber);
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData);
static real_T c4_emlrt_marshallIn(SFc4_vC_3ph_MR2InstanceStruct *chartInstance,
  const mxArray *c4_up_c, const char_T *c4_identifier);
static real_T c4_b_emlrt_marshallIn(SFc4_vC_3ph_MR2InstanceStruct *chartInstance,
  const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static const mxArray *c4_b_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static void c4_c_emlrt_marshallIn(SFc4_vC_3ph_MR2InstanceStruct *chartInstance,
...
static void c4_eml_scalar_eg(SFc4_vC_3ph_MR2InstanceStruct *chartInstance);
static const mxArray *c4_c_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static int32_T c4_d_emlrt_marshallIn(SFc4_vC_3ph_MR2InstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static uint8_T c4_e_emlrt_marshallIn(SFc4_vC_3ph_MR2InstanceStruct
  *chartInstance, const mxArray *c4_b_is_active_c4_vC_3ph_MR2, const char_T
  *c4_identifier);
static uint8_T c4_f_emlrt_marshallIn(SFc4_vC_3ph_MR2InstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void init_dsm_address_info(SFc4_vC_3ph_MR2InstanceStruct *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c4_is_active_c4_vC_3ph_MR2 = 0U;
}
  ...
  chartInstance)
{
  ...
  c4_d_hoistedGlobal = chartInstance->c4_is_active_c4_vC_3ph_MR2;
  ...
  *chartInstance, const mxArray *c4_st)
{
  ...
  *c4_up_c = c4_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c4_u,
    2)), "up_c");
  chartInstance->c4_is_active_c4_vC_3ph_MR2 = c4_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c4_u, 3)),
     "is_active_c4_vC_3ph_MR2");
  sf_mex_destroy(&c4_u);
  c4_update_debugger_state_c4_vC_3ph_MR2(chartInstance);
...
static void sf_c4_vC_3ph_MR2(SFc4_vC_3ph_MR2InstanceStruct *chartInstance)
{
  ...
  chartInstance->c4_sfEvent = CALL_EVENT;
  c4_chartstep_c4_vC_3ph_MR2(chartInstance);
...
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData)
{
  ...
  real_T c4_u;
  const mxArray *c4_y = NULL;
  SFc4_vC_3ph_MR2InstanceStruct *chartInstance;
  chartInstance = (SFc4_vC_3ph_MR2InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c4_vC_3ph_MR2_get_eml_resolved_functions_info(void)
{
  ...
  *c4_identifier)
{
  ...
  c4_y = c4_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c4_b_is_active_c4_vC_3ph_MR2), &c4_thisId);
  sf_mex_destroy(&c4_b_is_active_c4_vC_3ph_MR2);
  return c4_y;
}
...
/* SFunction Glue Code */
void sf_c4_vC_3ph_MR2_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c4_vC_3ph_MR2_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c4_vC_3ph_MR2(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[4],T\"up_a\",},{M[1],M[6],T\"up_b\",},{M[1],M[7],T\"up_c\",},{M[8],M[0],T\"is_active_c4_vC_3ph_MR2\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c4_vC_3ph_MR2_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc4_vC_3ph_MR2InstanceStruct *chartInstance;
    chartInstance = (SFc4_vC_3ph_MR2InstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c4_vC_3ph_MR2(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc4_vC_3ph_MR2InstanceStruct*) chartInstanceVar
    )->S,0);
  initialize_params_c4_vC_3ph_MR2((SFc4_vC_3ph_MR2InstanceStruct*)
    chartInstanceVar);
  initialize_c4_vC_3ph_MR2((SFc4_vC_3ph_MR2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c4_vC_3ph_MR2(void *chartInstanceVar)
{
  enable_c4_vC_3ph_MR2((SFc4_vC_3ph_MR2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c4_vC_3ph_MR2(void *chartInstanceVar)
{
  disable_c4_vC_3ph_MR2((SFc4_vC_3ph_MR2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c4_vC_3ph_MR2(void *chartInstanceVar)
{
  sf_c4_vC_3ph_MR2((SFc4_vC_3ph_MR2InstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c4_vC_3ph_MR2(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c4_vC_3ph_MR2
    ((SFc4_vC_3ph_MR2InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c4_vC_3ph_MR2();/* state var info */
...
extern void sf_internal_set_sim_state_c4_vC_3ph_MR2(SimStruct* S, const mxArray *
  st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c4_vC_3ph_MR2((SFc4_vC_3ph_MR2InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c4_vC_3ph_MR2(SimStruct* S)
{
  return sf_internal_get_sim_state_c4_vC_3ph_MR2(S);
}

static void sf_opaque_set_sim_state_c4_vC_3ph_MR2(SimStruct* S, const mxArray
  *st)
{
  sf_internal_set_sim_state_c4_vC_3ph_MR2(S, st);
}

static void sf_opaque_terminate_c4_vC_3ph_MR2(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc4_vC_3ph_MR2InstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c4_vC_3ph_MR2((SFc4_vC_3ph_MR2InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc4_vC_3ph_MR2((SFc4_vC_3ph_MR2InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c4_vC_3ph_MR2(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c4_vC_3ph_MR2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c4_vC_3ph_MR2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c4_vC_3ph_MR2(SimStruct *S)
{
  SFc4_vC_3ph_MR2InstanceStruct *chartInstance;
  chartInstance = (SFc4_vC_3ph_MR2InstanceStruct *)malloc(sizeof
    (SFc4_vC_3ph_MR2InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc4_vC_3ph_MR2InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c4_vC_3ph_MR2;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c4_vC_3ph_MR2;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c4_vC_3ph_MR2;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c4_vC_3ph_MR2;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c4_vC_3ph_MR2;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c4_vC_3ph_MR2;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c4_vC_3ph_MR2;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c4_vC_3ph_MR2;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c4_vC_3ph_MR2;
  chartInstance->chartInfo.mdlStart = mdlStart_c4_vC_3ph_MR2;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c4_vC_3ph_MR2;
...
void c4_vC_3ph_MR2_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c4_vC_3ph_MR2(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c4_vC_3ph_MR2(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c4_vC_3ph_MR2(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c4_vC_3ph_MR2_method_dispatcher.\n"
