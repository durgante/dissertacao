...
\section{Efeitos da Discretização}
    ...
    %
    %As figuras \ref{fig:pzmap_ic_vc}.\subref{fig:pzmap_ic} e \ref{fig:pzmap_ic_vc}.\subref{fig:pzmap_vc} apresentam o diagrama de pólos e zeros para o filtro LCL e demonstram esse efeito.
