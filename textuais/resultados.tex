...
\section{Resultados de Simulação}
  ...
  \begin{minipage}{\textwidth}
    ...
    \captionof{figure}{Comportamento da ação de controle na inicialização do sistema.}
  ...
  \begin{minipage}{\textwidth}
    ...
    \captionof{figure}{Comportamento dos ganhos adaptativos $\theta$ na inicialização do sistema.}
  ...
  \begin{minipage}{\textwidth}
    ...
    \captionof{figure}{Resposta da ação de controle ao degrau na referência.}
  ...
  \begin{minipage}{\textwidth}
    ...
    \captionof{figure}{Resposta dos ganhos adaptativos $\theta$ ao degrau na referência.}
  ...
  \begin{minipage}{\textwidth}
    ...
    \captionof{figure}{Ação de controle na presença de inversão de fase na referência.}
  ...
  \begin{minipage}{\textwidth}
    ...
    \captionof{figure}{Comportamento dos ganhos adaptativos $\theta$ mediante a inversão de fase na referência.}
  ...
  \begin{minipage}{\textwidth}
    ...
    \captionof{figure}{Resposta da corrente da rede a um curto-circuito na fase $a$.}
  ...
  \begin{minipage}{\textwidth}
    ...
    \captionof{figure}{Ação de controle na presença de curto-circuito na fase $a$.}
  ...
  \begin{minipage}{\textwidth}
    ...
    \captionof{figure}{Resposta dos ganhos adaptativos $\theta$ ao curto-circuito na fase $a$.}
  ...
  \begin{minipage}{\textwidth}
    ...
    \captionof{figure}{Resposta da corrente da rede à variação abrupta da indutância $L_g$.}
    \label{fig:i2_sim_Lg}
  \end{minipage}
  \vfill
  ...
  \begin{minipage}{\textwidth}
    ...
    \captionof{figure}{Ação de controle na presença de variação abrupta da indutância da rede $L_g$.}
    \label{fig:up_sim_Lg}
  \end{minipage}
  ...
  \begin{minipage}{\textwidth}
    ...
    \captionof{figure}{Resposta dos ganhos adaptativos $\theta$ à variação abrupta da indutância da rede $L_g$.}
  ...
  \begin{minipage}{\textwidth}
    ...
    \captionof{figure}{Comportamento da corrente da rede $i_2$ na inicialização do sistema.}
  ...
  \begin{minipage}{\textwidth}
    \makebox[\textwidth]{
      ...
      \def\svgwidth{\textwidth}
      \input{./img/logo.pdf_tex}}
    \captionof{figure}{Resposta da corrente da rede $i_2$ ao degrau na referência.}
  ...
  \begin{minipage}{\textwidth}
    \makebox[\textwidth]{
      ...
      \def\svgwidth{\textwidth}
      \input{./img/logo.pdf_tex}}
    \captionof{figure}{Resposta da corrente da rede $i_2$ à inversão de fase na referência.}
  ...
  As Fig.~\ref{fig:i2_sim_Lg_vc}-\ref{fig:thetas_sim_Lg_vc} apresentam a reação dos parâmetros do sistema a uma variação abrupta na indutância da rede $L_g$ no instante $t=2$ ciclos. A Fig.~\ref{fig:i2_sim_Lg_vc} apresenta a corrente da rede $i_2$, a Fig.~\ref{fig:up_sim_Lg_vc} apresenta a ação de controle $up$, e a Fig.~\ref{fig:thetas_sim_Lg_vc} apresenta o comportamento dos ganhos adaptativos $\theta$.
  ...
  \begin{minipage}{\textwidth}
    \makebox[\textwidth]{
      ...
      \def\svgwidth{\textwidth}
      \input{./img/logo.pdf_tex}}
    \captionof{figure}{Resposta da corrente da rede $i_2$ à variação abrupta da indutância $L_g$.}
