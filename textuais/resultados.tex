...
\section{Resultados de Simulação}
  ...
  \begin{minipage}{\textwidth}
    \makebox[\textwidth]{
      ...
      \def\svgwidth{\textwidth}
      \input{./img/logo.pdf_tex}}
    \captionof{figure}{Comportamento da ação de controle $u_p$ na inicialização do sistema.}
  ...
  \begin{minipage}{\textwidth}
    \makebox[\textwidth]{
      ...
      \def\svgwidth{\textwidth}
      \input{./img/logo.pdf_tex}}
    \captionof{figure}{Resposta dos ganhos adaptativos $\theta$ na inicialização do sistema.}
...
\section{Resultados Experimentais}
  ...
  %comentar sobre os resultados mostrados a seguir
  ...
  \begin{minipage}{\textwidth}
    ...
    \captionof{figure}{Resposta do normalizador à variação abrupta da indutância.}
    \label{fig:m_exp_Lg}
  \end{minipage}
  ...
  \begin{minipage}{\textwidth}
    ...
    \captionof{figure}{Regime permanente após o transitório de variação de indutância da rede.}
